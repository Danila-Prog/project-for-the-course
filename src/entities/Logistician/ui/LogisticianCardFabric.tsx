...
import CardDriver from "@/entities/Driver/ui/CardDriver";
...
export const LogisticianCardFabric = ({
  ...
  const { routeService, routeModel, userService, vehiclesService } = useDI();
  ...
  const route =
    routes && routeModel.findRouteByDriverId(routes, driver.driverId);
