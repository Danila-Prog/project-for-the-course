    ...
    <div className="mx-auto flex flex-col items-center">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col items-center">
        ...
        <button
          ...
          className="w-[300px] h-[50px] px-[16px] rounded-[25px] bg-orange-700 transition hover:bg-orange-800 text-white text-[20px] font-medium mt-[30px] disabled:opacity-70 mx-auto"
        >
